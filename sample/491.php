<?php
  // アクセス制限
  if(ereg("491.php", $_SERVER["PHP_SELF"]))
  {
  ...
  try
  {
    ...
    // データの編集
    $query = "UPDATE " . DIARY_TABLE_LOG
           . " SET title = '{$input_title}',story = '{$input_story}'"
           . " WHERE modify = '{$input_date}'";
    $result = @mysql_query($query, $db);

    if(!$result)
    {
      throw(new Exception("メッセージを編集できません"));
    }
...
<table border="0" cellspacing="0" cellpadding="0" width="500">
  ...
  <tr>
    <td align="center">
<font color="#ff3366">メッセージを編集しました</font><br>
<br>
